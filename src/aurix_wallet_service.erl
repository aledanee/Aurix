                        ...
                        case FiatBal >= TotalEurCents of
                            ...
                            true ->
                                ...
                                insert_outbox_event(Conn, TenantId, WalletId,
                                                    ...
                                                    UserId, <<"buy">>, GramsFloat,
                                                    GrossEurCents, FeeEurCents),
                                GoldBalFloat = parse_decimal(GoldBal),
                                NewGoldBal = GoldBalFloat + GramsFloat,
                                NewFiatBal = FiatBal - TotalEurCents,
                                {ok, #{
                                    transaction => #{
                                        id => TxnId,
                                        type => <<"buy">>,
                                    ...
                                    wallet => #{
                                        gold_balance_grams => NewGoldBal,
                                        fiat_balance_eur_cents => NewFiatBal
                                    }
                                }}
                        end
                end
                        ...
                        case GramsFloat =< GoldBalFloat of
                            ...
                            true ->
                                ...
                                insert_outbox_event(Conn, TenantId, WalletId,
                                                    ...
                                                    GrossEurCents, FeeEurCents),
                                NewGoldBal = GoldBalFloat - GramsFloat,
                                NewFiatBal = FiatBal + NetEurCents,
                                {ok, #{
                                    transaction => #{
                                        id => TxnId,
                                        type => <<"sell">>,
...
insert_outbox_event(Conn, TenantId, WalletId, EventType, TxnId,
                    UserId, Type, GramsFloat, GrossEurCents, FeeEurCents) ->
